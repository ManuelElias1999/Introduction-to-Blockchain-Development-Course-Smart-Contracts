...
contract Homework {
    ...
    event CProject(string Id, uint Estado);

    constructor (string memory _id, string memory _name, string memory _description, uint _fundrasingGoal){
        crowfunding = Crowfunding(_id, _name, _description, payable(msg.sender), 0, 0, _fundrasingGoal);
    }
    ...
    function FundProject() public payable NoOwnerFund{
        require (crowfunding.state != 1, "Te project cant recive funds");
